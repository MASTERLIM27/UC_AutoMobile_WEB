...
<head>
    ...
    <title>{{ config('app.name', 'UC AutoMobile') }}</title>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-auto">
                        <li class="nav-item">
                            <a class="nav-link {{ $active_projects ?? '' }}" href="{{ route('customers.index') }}">Customers</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link {{ $active_courses ?? '' }}" href="{{ route('vehicles.index') }}">Vehicles</a>
                        </li>
                    </ul>
                </div>
            </div>
